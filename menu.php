...
<body>
    <div class="container">
        ...
        <div class="d-flex p-2 justify-content-center bd-highlight">
            <a href="http://zend-rahema/ldap/buscarUsuari.php" class="verd">
                <div>
                    <center>
            ...
            <a href="http://zend-rahema/ldap/afegirUsuari.php" class="verd">
                <div>
                    <center>
            ...
            <a href="http://zend-rahema/ldap/modificarUsuari.php" class="groc">
                <div>
                    <center>
                        <svg xmlns="http://www.w3.org/2000/svg" width="150" height="150" fill="currentColor"
                            class="bi bi-person-plus-fill" viewBox="0 0 16 16">
            ...
            <a href="http://zend-rahema/ldap/esborrarUsuari.php" class="vermell">
                <div>
                    <center>
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
